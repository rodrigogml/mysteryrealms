...
- Os efeitos dos acampamentos são usados como modificadores nos testes e cálculos de [Recuperação por Sono](recuperacaoRecuperacaoPorSono.md) e [Descanso Passivo](recuperacaoDescansoPassivo.md).
...
A montagem de um acampamento exige esforço físico e tempo. Os valores seguem a lógica de [Ações do Jogador](acoesDoJogador.md):
...
O acampamento influencia diretamente os índices **S** e **C** calculados, que refletem diretamente na atividade **Dormir**. O cálculo segue normalmente o definido em [Recuperação#Recuperação por Sono](recuperacaoRecuperacaoPorSono.md).
