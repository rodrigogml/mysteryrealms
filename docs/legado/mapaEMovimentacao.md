A **PlayTale Engine** oferece suporte para dois tipos complementares de movimentação do jogador: entre **Localidades** e dentro de uma **Localidade**. Cada um desses modos utiliza lógicas distintas, mas coerentes com a [Estrutura de Localização](estruturaDeLocalizacao.md).
...
Toda a navegação do jogador no jogo ocorre exclusivamente entre **Zonas** e **Ambientes**. Esses são os únicos dois níveis da [Estrutura de Localização](estruturaDeLocalizacao.md) que possuem representação visual direta no jogo (como imagens e ilustrações específicas). Ou seja, são os únicos "lugares" que o jogador realmente vê e nos quais interage diretamente no sentido espacial e navegável.
...
----
- **Destino:** [#Nome da Zona ou Ambiente](#nome-da-zona-ou-ambiente) > [#Alternativa 1](#alternativa-1) > [#Alternativa 2](#alternativa-2)
...
- **Destino:** [#Taverna Asa Quebrada](#taverna-asa-quebrada) > [#Beco do Sapo](#beco-do-sapo) > [#Passagem Antiga](#passagem-antiga)
:* **Bidirecional:** Sim
...
- **Destino:** [#Praça das Vozes](#praca-das-vozes)
:* **Bidirecional:** Sim
:* **Classificação:** Pacificado
...
- **Destino:** [#Salão Principal](#salao-principal)
:* **Bidirecional:** Sim
:* **Classificação:** Pacificado
...
#### Salão Principal
- **Destino:** [#Taverna Asa Quebrada](#taverna-asa-quebrada)
:* **Bidirecional:** Sim
:* **Classificação:** Pacificado
