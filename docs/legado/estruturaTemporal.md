...
Para ações típicas, veja [Ações do Jogador](acoesDoJogador.md).
...
- Aumento da [Fadiga Mínima](fadigaFomeESedeFadigaMinima.md)
- Acúmulo de [Sede](fadigaFomeESedeSede.md)
