...
- Para completar cada hora de sono deve ser realizado o [Teste do Sono](testesDeJogoTesteDoSono.md).
...
### Interrupção do Sono
Durante a ação de **Dormir**, o jogador realiza uma série de [Teste de Sono](testesDeJogoTesteDeSono.md) para verificar se conseguirá dormir a noite inteira sem interrupções.

Ao começar a dormir já é realizado um [Teste de Sono](testesDeJogoTesteDeSono.md), e:
- Se passar no teste:
