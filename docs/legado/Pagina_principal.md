...
2. **[Estrutura de Localização](./Estrutura_de_Localizacao.md)** – A estrutura de localização define como os "lugares" do jogo são organizados e suas funções estratégicas.
 1. **[Mapa e Movimentação](./Mapa_e_Movimentacao.md)** – Conceitos sobre o mapa e especificações sobre a movimentação do jogador.
3. **[Economia](./Economia.md)** – Definição e controle do sistema monetário do jogo.
4. **[Raças e Classes](./Racas_e_Classes.md)** – Conceitos sobre definições de Raças e Classes do mundo. Ideias para diferentes jogos.
5. **[Danos e Aflições](./Danos_e_Aflicoes.md)** – Definição e explicação dos **tipos de dano** e dos **tipos de aflição** que são suportados pela engine.
6. **[Defesa e Bloqueio](./Defesa_e_Bloqueio.md)** – Explicações da diferença entre "Defesa do Ataque" e "Bloqueio do Dano", entre outras definições relacionadas.
7. **[Tipos de Resistências](./Tipos_de_Resistencias.md)** – Explicações sobre os diferentes tipos de Resistências (Física, Elementais, Mágicas, Aflições, Mentais e Espirituais).
8. **[Moral](./Moral.md)** – Definição sobre o estado mental do jogador.
9. **[Acampamentos](./Acampamentos.md)** – Definições e conceitos sobre o funcionamento dos acampamentos.
...
2. **[Fadiga, Fome e Sede](./Fadiga_Fome_e_Sede.md)** – Conceito e funcionamento sobre a Fadiga, Fome e Sede.
3. **[Recuperação](./Recuperacao.md)** – Explicação dos diferentes tipos de descansos e recuperação possíveis do personagem.
4. **[Morte e Desmaios](./Morte_e_Desmaios.md)** – Definições sobre morte e desmaio do jogador.
5. **![Ações do Jogador](./Acoes_do_Jogador.md)** – Definição dos detalhes das ações que podem ser tomadas pelo jogador.
...
2. **[Testes de Jogo](./Testes_de_Jogo.md)** – Documentação dos diferentes tipos de testes realizados durante o jogo, que determinam o sucesso ou insucesso do jogador em suas ações (ou mesmo de eventos e acontecimentos do jogo).
3. **[Ficha do Jogador](./Ficha_do_Jogador.md)** – Nesta página é abordada a ficha do jogador, explicados seus atributos, sua matemática, e todo o controle das informações do jogador.
...
2. **Interação com NPCs** – Bloco com as definições da mecânica das interações e relacionamento entre o jogador e os NPCs.
 ...
 2. **[Estrutura de Diálogo](./Estrutura_de_Dialogo.md)** – Definições de como criar, organizar e documentar os fluxos de diálogo.
...
2. **[Modelo de Ficha de Personalidade](./Modelo_de_Ficha_de_Personalidade.md)** – Modelo de ficha utilizada para guiar a criação de personalidades do jogo.
3. **[Modelo de Ficha de Diálogo](./Modelo_de_Ficha_de_Dialogo.md)** – Modelo de ficha utilizada para guiar a criação de um diálogo.
4. **[Modelo de Ficha de Tipo de Arma](./Modelo_de_Ficha_de_Tipo_de_Arma.md)** – Modelo de ficha utilizada para guiar a criação dos tipos de armas do jogo.
5. **[Modelo de Ficha de Itens de Mão](./Modelo_de_Ficha_de_Itens_de_Mao.md)** – Modelo de ficha utilizada como base na criação de qualquer uma das fichas a seguir dos itens de mão.
 ...
 2. **[Modelo de Ficha de Escudos](./Modelo_de_Ficha_de_Escudos.md)** – Modelo de ficha utilizada para guiar a criação do Item de Mão do subtipo "escudo" para o jogo.
6. **Modelos de Fichas de Lugares**
 ...
 2. **[Modelo de Ficha de Ambientes](./Modelo_de_Ficha_de_Ambientes.md)** – Modelo de ficha utilizada para guiar a criação de um Ambiente.
...
2. **[Classes](./Classes.md)** – Classes dos aventureiros.
3. **Lugares** – "Lugares" é a expressão utilizada para todo e qualquer tipo de lugar físico do jogo. No entanto cada lugar representa um escopo diferente de agrupamento e regras.
 ...
 2. **[Biblioteca Varnak](./Biblioteca_Varnak.md)** – Torre arcana viva onde o conhecimento se molda ao visitante. Contém seções mutáveis e guardiões mágicos.
 ...
 3. **[Forja dos Ecos](./Forja_dos_Ecos.md)** – Forja ancestral onde itens são imbuídos com identidade, operada por [Thramur Ankuhl](./Thramur_Ankuhl.md) e sua aprendiz rúnica.
 ...
 4. **[Arsenal Três Lâminas](./Arsenal_Tres_Laminas.md)** – Loja especializada em itens recuperados de ruínas and campos de batalha, respeitada por sua neutralidade comercial.
 ...
 5. **[Praça das Vozes](./Praca_das_Vozes.md)** – Coração público e comercial de Langur, repleto de vozes, comércio, rumores e manifestações diversas.
 ...
 6. **[Casa de Custódia](./Casa_de_Custodia.md)** – Instituição bancária e mágica onde são guardados itens, contratos e segredos dos poderosos.
 ...
 7. **[Mercado da Pedra Branca](./Mercado_da_Pedra_Branca.md)** – Principal centro de suprimentos e artigos básicos de Langur, sempre ativo e cercado de boatos e ofertas.

4. **[Conexões de Mystery Realms](./Conexoes_de_Mystery_Realms.md)** – Mapa de navegação do Mystery Realms (conexões das Zonas e Ambientes).
5. **Personagens** – Ficha de Personagens (NPCs, Personalidades e outros) existentes no jogo.
 ...
 2. **[Elvarin do Silêncio](./Elvarin_do_Silencio.md)** – É um sábio andarilho, membro da [Ordem dos Caminhantes Silenciosos](./Faccoes.md#ordem_dos_caminhantes_silenciosos), que atua como guia filosófico e conselheiro na [Praça das Vozes](./Langur.md#praca_das_vozes). Com fala metafórica e olhar contemplativo, representa uma âncora narrativa para o jogador logo no início da jornada em [Mystery Realms](./Roteiro_Inicial.md).
 3. **[Garrun Ferres](./Garrun_Ferres.md)** – É um ex-batedor de caravanas que perdeu parte da perna em uma emboscada e agora é dono do [Estábulo Ferradura Partida](./Langur.md#estabulo_ferradura_partida). É referência em montadorias e conhece como ninguém as rotas e os perigos das estradas que cercam [Langur](./Langur.md).
 4. **[Kaela Runaveia](./Kaela_Runaveia.md)** – É uma jovem aprendiz de ferreiro rúnico acolhida por [Thramur Ankuhl](./Thramur_Ankuhl.md) na [Forja dos Ecos](./Langur.md#forja_dos_ecos). Apesar de sem formação mágica formal, possui uma conexão misteriosa com runas, que parecem reconhecê-la.
 5. **[Lirianne Morth](./Lirianne_Morth.md)** – É a enigmática Alta Guardiã da [Biblioteca Varnak](./Langur.md#biblioteca_varnak), conhecida por sua disciplina inabalável, memória perfeita e habilidade em detectar mentiras. Vive reclusa na biblioteca, onde rumores indicam que nasceu e nunca saiu.
 6. **[Madalin Crestamar](./Madalin_Crestamar.md)** – É a coordenadora do [Mercado da Pedra Branca](./Langur.md#mercado_da_pedra_branca), uma figura respeitada e temida no comércio de Langur. Herdou o cargo do pai e controla tudo o que entra e sai do mercado com mão firme, olhos atentos e senso apurado de justiça e preço justo.
 7. **[Oskar Brünn](./Oskar_Brunn.md)** – É o severo tesoureiro-chefe da [Casa de Custódia](./Langur.md#casa_de_custodia) de Langur, respeitado por sua integridade inflexível e por ter criado o sistema de vedação rúnica mais seguro do continente. Ex-criptógrafo de guerra, atua como guardião arcano-financeiro da cidade.
 8. **[Silma Verridan](./Silma_Verridan.md)** – É uma ex-caçadora de artefatos que quase morreu em uma expedição e agora trabalha no [Arsenal Três Lâminas](./Langur.md#arsenal_tres_laminas) como avaliadora de relíquias, sendo temida por sua precisão, franqueza e integridade inflexível.
 9. **[Thramur Ankuhl](./Thramur_Ankuhl.md)** – É um mestre ferreiro anão da [Forja dos Ecos](./Langur.md#forja_dos_ecos), último herdeiro da Tradição de Dhurrak. Sobrevivente de uma tragédia rúnica, forja armas que reagem à alma do portador e despreza magos e clientes vaidosos.
 10. **[Vareth Dolmar](./Vareth_Dolmar.md)** – É um ex-mercenário que fundou o [Arsenal Três Lâminas](./Langur.md#arsenal_tres_laminas) em Langur, onde negocia armas e artefatos de zonas de guerra com lábia afiada e um olhar preciso para o valor oculto dos itens.
 2. **Personalidades** – "Personalidades" é como são chamados os personagens ou nomes de pessoas que aparecem no jogo mas não são NPCs. Por exemplo, um réu antigo, um Lord que deu nome a uma cidade ou ponte, etc., alguma personalidade que é citada ou tem história no jogo, mas não é possível interagir no jogo.
...
6. **[Facções](./Faccoes.md)** – Detalhes sobre as Facções (Grupos, Guildas, Ordens, Tributos, Seitas, etc.) existentes no jogo.
...
2. **[Roteiro Inicial](./Roteiro_Inicial.md)** – Roteiro inicial base do jogo, contando a história base do jogo, com diálogos dos NPCs e outras narrações.
...
2. Escolha de ação (ataque, defender, usar item, fugir, habilidade).
3. Teste de ataque e defesa:
...
4. Cálculo de dano.
5. Aplicação de efeitos (envenenamento, perda de moral, etc.).
6. Verificação de morte/retirada.
