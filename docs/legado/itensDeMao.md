...
- **Nome**
- **Subtipo de Item**: arma, escudo, foco mágico, lanterna, ferramenta, relíquia, etc. Conforme descrito em [#Subtipos de Itens de Mão](#subtipos-de-itens-de-mao).
...
- Personagens podem alternar entre itens nas mãos como **ação de pré-turno** (ver [Ciclo de Batalha](cicloDeBatalha.md)).
