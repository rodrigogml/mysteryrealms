> **Imagem de referência indisponível no export:** `ArsenalTresLaminas_SalaoDaLoja.png`
...
:* Ao fundo, um balcão largo de madeira escura percorre toda a largura da parede, fazendo uma curva em "L". No lado esquerdo do balcão, [Silma Verridan](silmaVerridan.md) examina itens trazidos por clientes com sua lupa de lentes duplas e mãos ágeis. No lado direito, [Vareth Dolmar](varethDolmar.md) se apoia com os cotovelos na madeira, observando os visitantes com ar de desafio e ironia, pronto para barganhar com quem ousar.
...
:* [Silma Verridan](silmaVerridan.md) pode reconhecer itens raros e oferecer quests relacionadas.
