...
1. Jogador B (22)
1. Jogador A (19)
1. Monstro (19) — atrás de A por ter menor Destreza
...
**Precisão** do agressor, obtida na ficha do agressor, ou na ficha do jogador no atributo [Precisão](fichaDoJogadorPrecisao.md).

O resultado deve ser comparado à **Defesa** do alvo. Se for do jogador, encontrada na ficha do jogador no atributo [Defesa](fichaDoJogadorDefesa.md).
...
> **Nota:** O dano causado após o acerto é calculado separadamente. Veja [Batalha#Cálculo de Dano](batalhaCalculoDeDano.md).
...
O **[Dano Base](fichaDoJogadorDanoBase.md)** é determinado pelo tipo de arma utilizada e raça/classe, e pode ser obtido diretamente da ficha do jogador.

Além do **[Dano Base](fichaDoJogadorDanoBase.md)**, é necessário considerar outros modificadores ativos. Os modificadores ativos na ficha do jogador já são tonabilizadoe no atributo **[Dano Atual](fichaDoJogadorDanoAtual.md)** da Ficha do Jogador.
...
O teste de sono verifica se o jogador conseguiu dormir 1h completa ao tentar a ação de dormir, e leva em consideração os atributos do sono **C**, **R** e **S** definidos em **[Qualidade do Sono](recuperacaoQualidadeDoSono.md)**.
...
- Ao ocorrer um evento hostil, caso o agressor esteja em modo furtivo (tentando um furto), deve-se realizar um [Teste de Percepção](testesDeJogoTesteDePercepcao.md) para verificar se o jogador acorda. Se acordar leva e pode se defender, se não acordar continua com os benefícios da recuperação de Dormir, mas é furtado.
