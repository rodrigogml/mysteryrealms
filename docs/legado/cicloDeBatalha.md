...
Assim que o encontro é iniciado, é feito um [Teste de Percepção](testesDeJogo.md) para determinar quem percebe o outro primeiro — jogador ou criatura. Caso o inimigo tenha sucesso e o jogador seja surpreendido, poderá sofrer um ataque antecipado antes da rotação normal de turnos começar.

## Teste de Iniciativa

Com ambos cientes da presença um do outro, realiza-se um [Teste de Iniciativa](testesDeJogo.md) para determinar a ordem dos turnos no combate. A maior iniciativa age primeiro.
...
Cada ação ofensiva ou defensiva exige um ou mais [Testes de Jogo](testesDeJogo.md), como:
- Teste de Acerto
- Teste de Bloqueio
- Cálculo de Dano
