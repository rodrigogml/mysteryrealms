...
- **Experiência Direta (Prática):** A utilização frequente de uma habilidade pode melhorar sua eficácia com o tempo, representando prática e domínio crescente.  Essa evolução é melhor explicada na página [Página sobre a progressão do jogo](paginaSobreAProgressaoDoJogo.md).
...
- **Moral:** Pontos de Moral do Jogador, conforme definido em [Moral](moral.md). Valores de 0 a 100.
...
- : Quando o jogador está carregando entre a [#Capacidade de Carga Atual (Kg)](#capacidade-de-carga-atual-kg) e a [#Carga Crítica Atual (Kg)](#carga-critica-atual-kg) o personagem está com **Sobrecarga**, mas ainda pode se mover, mas com penalidades (veja mais em [Sobrecarga](sobrecarga.md)).
- : Quando o personagem está carrendo acima da [#Carga Crítica Atual (Kg)](#carga-critica-atual-kg), o personagem está com Carga Crícita e não poderá se mover até se livrar do sobrepeso.
- **Fórmula:**
...
### Fadiga Máxima
- **Definição:** Pontos de Fadiga máxima até que o jogador pode ter até entrar em **Exaustão**. Medida em pontos conforme definido em [Fadiga Máxima](fadigaFomeESedeFadigaMaxima.md).
...
Segue a definição e cálculo definidos em [Fadiga Mínima](fadigaFomeESedeFadigaMinima.md).

### Exaustão
- **Definição:** Define a pontução máxima de Fadiga antes que o jogador desmais e exaustão. Sempre ser maior que a **Fadiga Máxima**, calculado conforme definido em [Exaustão](fadigaFomeESedeExaustao.md).
