...
/**
 * Entidade JPA que representa o impacto de uma entrada de diário em uma reputação.
 *
 * @author ?
 * @since 28-04-2026
 */
@Entity
@Table(name = "diaryImpactReputation")
public class DiaryImpactReputationEntity {
