 ...
 */
public final class ServicoNavegacao {

    private ServicoNavegacao() {}
     ...
     */
    public static double distanciaBaseKm(double x1, double y1, double x2, double y2) {
        double dx = x2 - x1;
        double dy = y2 - y1;
     ...
     */
    public static double distanciaAjustadaKm(double distBaseKm, double penaldadeRotaPct) {
     ...
     */
    public static double chanceInterrupcaoPorSegmento(double chanceKmPct, double distanciaKm) {
        if (distanciaKm < 1.0) {
     ...
     */
    public static long tempoDeslocamentoMinutos(
     ...
     */
    public static double custoFadigaPorTrecho(double custoPorMinuto, long minutosTrecho) {
