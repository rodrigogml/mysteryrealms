...
public final class ModifierService {
    ...
    public static List<Modifier> apply(List<Modifier> ativos, Modifier novo) {
        ...
        switch (novo.regraEmpilhamento()) {
            case ACCUMULATES -> ativos.add(novo);
     ...
     *
     * Critérios em caso de conflito (mesmo id, mesma origem, regra REPLACES):
     ...
     */
    private static boolean substituirConflitante(List<Modifier> ativos, Modifier novo) {
     ...
     */
    public static List<Modifier> byOrigin(List<Modifier> ativos, ModifierOrigin origem) {
     ...
     */
    public static List<Modifier> sortedByPriority(List<Modifier> ativos) {
