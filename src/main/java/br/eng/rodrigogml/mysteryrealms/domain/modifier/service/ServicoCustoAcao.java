 ...
 */
public final class ServicoCustoAcao {

    private ServicoCustoAcao() {}
     ...
     */
    public static CustoAcao custoBase(ClasseAcao actionClass) {
        return switch (actionClass) {
            case PASSIVA      -> new CustoAcao(5,   2.0,  0.05,  0.15);
            case MODERADA     -> new CustoAcao(10,  8.0,  0.20,  0.60);
            case EXIGENTE     -> new CustoAcao(15, 20.0,  0.50,  1.20);
            case RECUPERATIVA -> new CustoAcao(20, -12.0, -0.40, -0.80);
        };
    }
     ...
     */
    public static void aplicarModificadorClima(CustoAcao cost, ClasseAcao actionClass, String condition) {
        ...
        switch (condition.toUpperCase()) {
            ...
            case "RAIN" -> {
                if (actionClass == ClasseAcao.MODERADA || actionClass == ClasseAcao.EXIGENTE) {
     ...
     */
    public static void aplicarModificadorCarga(CustoAcao cost, ClasseAcao actionClass, double cargaRatio) {
        if (cargaRatio > 1.0) {
            if (actionClass == ClasseAcao.EXIGENTE) {
     ...
     */
    public static void aplicarModificadorFisiologico(
            CustoAcao cost,
            boolean isExaustao,
            boolean isSede,
     ...
     * @return novo {@link CustoAcao} com todos os modificadores aplicados
     */
    public static CustoAcao calcularCusto(
            ClasseAcao actionClass,
        ...
        CustoAcao cost = custoBase(actionClass);
        aplicarModificadorClima(cost, actionClass, weatherCondition);
        aplicarModificadorCarga(cost, actionClass, cargaRatio);
        aplicarModificadorFisiologico(cost, isExaustao, isSede, isSedeAgravada,
